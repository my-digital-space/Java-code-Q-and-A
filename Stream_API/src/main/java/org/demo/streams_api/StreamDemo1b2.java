...
public class StreamDemo1b2 {
    ...
    public static void main(String[] args) {
        Employee emp1 = new Employee(
                1, "EmpName1", "Dept1", BigDecimal.valueOf(200.00), 50); // 4th Highest
        Employee emp2 = new Employee(
                2, "EmpName2", "Dept2", BigDecimal.valueOf(400.00), 35); // 2nd Highest
        Employee emp3 = new Employee(
                3, "EmpName3", "Dept3a", BigDecimal.valueOf(100.00), 25); // 5th Highest
        Employee emp4 = new Employee(
                4, "EmpName4", "Dept3b", BigDecimal.valueOf(100.00), 32); // 5th Highest
        Employee emp5 = new Employee(
                5, "EmpName5", "Dept3c", BigDecimal.valueOf(100.00), 28); // 5th Highest
        Employee emp6 = new Employee(
                6, "EmpName6", "Dept4", BigDecimal.valueOf(300.00), 54); // 3rd Highest
        Employee emp7 = new Employee(
                7, "EmpName7", "Dept5", BigDecimal.valueOf(500.00), 25); // 1st Highest
